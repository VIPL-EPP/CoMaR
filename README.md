...
- [x] Release evaluation model checkpoints and evaluation code for CoMaR_etpnav.
- [x] Release evaluation model checkpoints and evaluation code for CoMaR_g3D-LF.
- [ ] Release training pipeline and training code for CoMaR_etpnav.
- [ ] Release training pipeline and training code for CoMaR_g3D-LF.
