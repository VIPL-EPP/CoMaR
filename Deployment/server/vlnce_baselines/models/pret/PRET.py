...
config = BertModel.config_class.from_pretrained("/home/houjiewen/g3d/Server_g3d/bert_config/bert-base-uncased")
...
class PRET(nn.Module):
    ...
    def forward_CCM(self, path_features, gmap_features, gmap_logits, txt_embeds, txt_masks, padding_mask=None, visited_mask=None):
        """
        Args:
            path_feature: (B, N, C)
            padding_mask: (B, N)
        Returns:
            (B, N)
        """
        padding_mask = padding_mask | visited_mask
