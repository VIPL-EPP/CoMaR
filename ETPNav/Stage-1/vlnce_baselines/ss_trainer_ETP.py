...
class RLTrainer(BaseVLNCETrainer):
    ...
    def rollout(self, mode, ml_weight=None, sample_ratio=None):
        ...
        for stepk in range(self.max_len):
            ...
            # nav_logits = path_score
            # nav_probs = F.softmax(nav_logits, 1) * 0.8 + probs * 0.2
            ...
            if mode == 'train':
                ...
                path_loss += F.cross_entropy(path_score, teacher_actions, reduction='sum', ignore_index=-100)
        ...
        if mode == 'train':
            ...
            # self.logs['IL_total_loss'].append(self.loss.item())