...
class ETP(Net):
    def __init__(
        ...
        #         spatial_output=model_config.spatial_output,
        #     )
        self.rgb_encoder = CLIPEncoder("/home/houjiewen/g3D-LF-main/3dg-LF/ViT-L-14-336px.pt",self.device)
        ...
        self.STOP_embedding.requires_grad = False
    ...
    def forward(self, mode=None, 
                ...
                path_feature=None, padding_mask=None, unvisited_or_current=None, gmap_features=None, gmap_logits=None):
        ...
        if mode == 'language':
            ...
            path_logits, gmap_logits, residual_logits, final_logits, weight = self.pret.forward_CCM(path_feature, gmap_features, gmap_logits, txt_embeds, txt_masks, padding_mask)
